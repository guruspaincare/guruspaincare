...
<head>
	...
	<meta name="description" content="GV Speciality Hospital is a regional healthcare system that serves residents in Tamilnadu">
	<meta name="author" content="GV Speciality Hospital">
	<meta name="format-detection" content="telephone=no">
	<title>GV Speciality Hospital</title>
	<!-- Stylesheets -->
	...
	<!-- Google map -->
	<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyA8QFBfASNKXktDVtY8TjcXYh9n7Uodszo"></script>
</head>
			...
			<div class="container">
				<div class="row align-items-center">
					<div class="col-auto d-flex align-items-center">
						<div class="header-phone"><i class="icon-telephone"></i><a href="tel:+917598098150">+917598098150</a></div>
						<div class="header-info"><i class="icon-placeholder2">C-153, Kannadhasan St,Anna Nagar, Tennur, Trichy, Tamil Nadu, 620017</i></div>
						<div class="header-info"><i class="icon-black-envelope"></i><a href="mailto:info@guruspaincare.com">info@guruspaincare.com</a></div>
					</div>
					<div class="col-auto ml-auto d-flex align-items-center">
						<span class="header-social">
							<a href="https://www.facebook.com/guruspaincare/" class="hovicon"><i class="icon-facebook-logo-circle"></i></a>
							<a href="https://twitter.com/guruspaincare" class="hovicon"><i class="icon-twitter-logo-circle"></i></a>
						</span>
					</div>
				</div>
			</div>
 ...
 <!--<div class="header-content">
			<div class="container">
				<div class="row align-items-lg-center">
					...
					<div class="col-lg-auto col-lg-2 d-flex align-items-lg-center">
						<a href="index.html" class="header-logo"><img src="logo_top.jpeg" alt="" class="img-fluid"></a>
					</div>
				...
				<div class="quickLinks js-quickLinks">
					<div class="container">
						<div class="row no-gutters">
							...
							<div class="col">
								<a href="#" class="link">
									<i class="icon-clock"></i><span>Doctor visit</span>
								</a>
								<div class="link-drop">
							...
							<div class="col">
								<a href="#" class="link">
									<i class="icon-pencil-writing"></i><span>Services</span>
								</a>
								<div class="link-drop">
							...
							<div class="col">
								<a href="#" class="link">
									<i class="icon-calendar"></i><span>Doctors</span>
								</a>
								<div class="link-drop">
						...
						-->
							<div class="col">
								...
								<div class="link-drop">
									...
									<p>Please call us for any Emergency </p>
									<ul class="icn-list">
										<li><i class="icon-telephone"></i><span class="phone">+917598098150<br>+919444733322</span>
										</li>
										<li><i class="icon-black-envelope"></i><a href="mailto:info@guruspaincare.com">info@guruspaincare.com</a></li>
									</ul>
					...
					<div class="slide">
						...
						<div class="slide-content center">
							<div class="vert-wrap container">
								<div class="vert">
									<div class="container">
										<div class="slide-txt1" data-animation="fadeInDown" data-animation-delay="1s">GV Spacility Hospital -The Highest Quality
										...
										<div class="slide-btn"><a href="#" class="btn btn-white" data-animation="fadeInUp" data-animation-delay="2s"><i class="icon-right-arrow"></i><span>Know more</span><i class="icon-right-arrow"></i></a></div>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="slide">
						...
						<div class="slide-content center">
							<div class="vert-wrap container">
								<div class="vert">
									<div class="container">
										<div class="slide-txt1" data-animation="fadeInDown" data-animation-delay="1s">GV Spacility Hospital Provide
		...
		<div class="section">
			<div class="container pt-lg-2">
				<div class="title-wrap text-center text-md-left d-lg-none mb-lg-2">
					<div class="h-sub">15 Years of Medical Excellence</div>
					<h2 class="h1">Welcome to <span class="theme-color">Our Clinic</span></h2>
				</div>
				<div class="row mt-2 mt-md-3 mt-lg-0">
					...
					<div class="col-md-6 mt-3 mt-md-0">
						<div class="video-wrap embed-responsive embed-responsive-16by9">
							<iframe src="https://www.facebook.com/plugins/video.php?href=https%3A%2F%2Fwww.facebook.com%2Fguruspaincare%2Fvideos%2F1121597571281822%2F&width=250&show_text=false&height=350&appId" width="250" height="350" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowfullscreen="true" allow="autoplay; clipboard-write; encrypted-media; picture-in-picture; web-share" allowFullScreen="true"></iframe>
						</div>
					</div>
				</div>
			</div>
	...
	-->
		...
		<div class="section">
			<div class="container">
				<div class="title-wrap text-center">
					<h2 class="h1">What We Also Do</h2>
					<div class="h-decor"></div>
				</div>
				<div class="single-service-carousel js-single-service-carousel">
						...
						<div class="row">
							<div class="col-md">
								<div class="text-right pl-0 pl-md-3 pl-lg-6">
									<h3>Nursing</h3>
									<p>Our nurse practitioners and primary care nurses work with your family doctor to help manage and provide advice on many conditions including diabetes, depression and high cholesterol. They can assist you with your overall health, monitoring and managing your chronic health conditions.</p>
									<div class="btn-wrap"><a href="service-page.html" class="btn btn-hover-fill"><i class="icon-right-arrow"></i><span>Read more</span><i class="icon-right-arrow"></i></a></div>
								</div>
							</div>
					...
					<div class="single-service">
						<div class="row">
							...
							<div class="col-md">
								<div class="text-left pr-0 pr-md-3 pr-lg-6">
									<h3>Friends and Family Test</h3>
									<p>We would like your feedback on the care or treatment we give you any time you visit your GP or have contact with the practice. It doesn't take long. Put us to the test and tell us what is working and what we can improve. You can say what you think without giving your name and we will use the information to plan improvements to our services.</p>
									<div class="btn-wrap"><a href="service-page.html" class="btn btn-hover-fill"><i class="icon-right-arrow"></i><span>Read more</span><i class="icon-right-arrow"></i></a></div>
								</div>
							</div>
						</div>
			...
			<div class="container-fluid px-0">
				<div class="banner-center bg-cover" style="background-image: url(images/content/banner-center-02.jpg)">
					<div class="banner-center-caption text-center">
						...
						<div class="banner-center-text4">You can now book a limited amount of doctors’ appointments online</div>
						<a href="#" class="btn btn-white mt-2 mt-sm-3 mt-lg-5"><i class="icon-right-arrow"></i><span>Doctor Timetable</span><i class="icon-right-arrow"></i></a>
					</div>
				</div>
			</div>
		</div>
				...
				<div class="row">
					<div class="col-sm">
						<div class="icn-text-num">
							...
							<div class="icn-text-num-title">Premium Health Services</div>
							<div class="icn-text-num-text">
								<p>When you sit down with one of our pharmacists, you receive one hour of his/her attention. Our pharmacist will listen to your concerns, conduct a thorough medication review, and help you find a healthier you. Our pharmacist is here to help you understand your health and well-being.</p>
							</div>
						</div>
					</div>
					<div class="col-sm">
						<div class="icn-text-num">
							...
							<div class="icn-text-num-title">Main Focus of Our Private Clinic</div>
							<div class="icn-text-num-text">
								<p>Our patients receive personalized care that is affordable and attentive, with many of them being with us since opening day in 1996. We are well tuned to providing the best medical services for everyone, whether you’re passing through or have lived here for years.</p>
							</div>
						</div>
					</div>
					<div class="col-sm">
						<div class="icn-text-num">
							...
							<div class="icn-text-num-title">Receive Quality Care from Our Staff</div>
							<div class="icn-text-num-text">
								<ul class="marker-list-md-line">
									<li>Maximizing technology for better outcomes</li>
									<li>Personalized care, tailored to your needs</li>
									<li>Focus on long-term health and prevention</li>
				...
				<div class="banner-call">
					<div class="row no-gutters">
						<div class="col-sm-5 col-lg-5 order-2 order-sm-1 mt-3 mt-md-0 text-center text-md-right">
							<img src="images/content/banner-callus.png" alt="" class="shift-left-1">
						</div>
						<div class="col-sm-7 col-lg-7 col-lg-7 d-flex align-items-center order-1 order-sm-2">
							<div class="text-center pt-2 pt-lg-8">
								<h2>Looking for <br class="d-lg-none"> a <span class="theme-color">Certified Doctor?</span></h2>
								<div class="h-decor"></div>
								<p class="mt-sm-1 mt-lg-4 text-left text-sm-center max-575">We're always accepting new patients! We believe in providing the best possible care to all our existing patients and welcome new patients to sample the service we have to offer. </p>
								<div class="mt-3 mt-lg-4">
									<a href="#" class="banner-call-phone"><i class="icon-telephone"></i>+917598098150</a>
								</div>
							</div>
						</div>
					</div>
		...
		<div class="container">
			<div class="row py-1 py-md-2 px-lg-0">
					...
					<div class="row flex-column flex-md-row flex-lg-column">
						<div class="col-md col-lg-auto">
							<div class="footer-logo">
								<img src="images/logo_top.jpeg" alt="" class="img-fluid">
							</div>
							<div class="mt-2 mt-lg-0"></div>
							<div class="footer-social d-none d-md-block d-lg-none">
								<a href="https://www.facebook.com/guruspaincare/" target="blank" class="hovicon"><i class="icon-facebook-logo"></i></a>
								<a href="https://twitter.com/guruspaincare" target="blank" class="hovicon"><i class="icon-twitter-logo"></i></a>
							</div>
						</div>
						<div class="col-md">
				...
				<div class="col-sm-6 col-lg-4">
					...
					<div class="h-decor"></div>
					<ul class="icn-list">
						<li><i class="icon-placeholder2"></i>C-153, Kannadhasan St, Hidayath Nagar, Anna Nagar, Tennur, Tiruchirappalli, TN 620017
							<br>
						...
						<li><i class="icon-telephone"></i><b><span class="phone"><span class="text-nowrap">+917598098150</span>, <span class="text-nowrap">+917598098150</span></span></b>
		...
		<div class="footer-bottom">
			<div class="container">
				<div class="row text-center text-md-left">
					<div class="col-sm">Copyright © 2021 <a href="#">GV Speciality Hospital</a><span>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;</span>
						<a href="#">Privacy Policy</a></div>
					<div class="col-sm-auto ml-auto"><span class="d-none d-sm-inline">For emergency cases&nbsp;&nbsp;&nbsp;</span><i class="icon-telephone"></i>&nbsp;&nbsp;<b>+917598098150</b></div>
				</div>
			</div>
		</div>
	</div>
    ...
    <script type="text/javascript">function add_chatinline(){var hccid=74106435;var nt=document.createElement("script");nt.async=true;nt.src="https://www.mylivechat.com/chatinline.aspx?hccid="+hccid;var ct=document.getElementsByTagName("script")[0];ct.parentNode.insertBefore(nt,ct);}
